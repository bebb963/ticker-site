...
export default function ScoreResult({ result, onRestart }: ScoreResultProps) {
  const whatsappMessage = encodeURIComponent(
    `Olá! Fiz o Ticker Score e obtive ${result.score}/100. Gostaria de validar o diagnóstico com um especialista.`
  )
    ...
    <div className="score-result">
      <div className="score-result-inner">
          ...
          <section className="score-result-section">
            ...
            <ul className="score-opp-list">
              {result.risks.map((risk, i) => (
                <li key={i} className="score-opp-item score-opp-risk">
        ...
        {result.priorities.length > 0 && (
          <section className="score-result-section">
            <h2 className="score-section-title">Prioridades Recomendadas</h2>
        ...
        <section className="score-result-cta">
          ...
          <div className="score-cta-actions">
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="score-cta-btn score-cta-whatsapp">
